...
import furCoat from '../assets/images/image-grid/fur-coat.jpg';
import redDress from '../assets/images/image-grid/red-dress.jpg';
import vogue from '../assets/images/image-grid/vogue.jpg';
...
const Grid = () => {
  return (
    <div className='container lg:px-32 px-4 py-8 mx-auto items-center'>
      ...
      <div className='grid overflow-hidden grid-cols-9 grid-rows-5 gap-2'>
        <div className='box row-start-1 row-end-3 col-start-1 col-end-3'>
          <img
          src={furCoat}
            // src={
        ...
        <div className='box row-start-3 row-end-6 col-start-1 col-end-3'>
          <img
            src={sassy}
            alt={''}
            className='inset-0 h-full w-full object-cover object-center rounded opacity-75 hover:opacity-100'
        ...
        <div className='box row-start-1 row-end-4 col-start-3 col-end-12'>
          <img
            //   src={
        ...
        <div className='box row-start-4 row-end-6 col-start-3 col-end-6'>
          <img
            // src={
        ...
        <div className='box row-start-4 row-end-6 col-start-6 col-end-12'>
          <img
            // src={
